...
- **Sheng Zhang**, Maolin Wang, Yao Zhao, Chenyi Zhuang, Ruocheng Guo, Xiangyu Zhao et al. (2024). *DNS-Rec: Data-aware Neural Architecture Search for Recommender Systems*. In *ACM Conference on Recommender Systems* (***RecSys***) (***CCF-B***) \[***Oral***\].
